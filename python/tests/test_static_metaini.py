...
def test_static1():
    ...
    assert(str(static) == "{'G1_0000': {'COMPILE_DEFINITIONS': {'GRID': 'G1', 'SOLVER': 'Solver1b'}}, 'G1_0001': {'COMPILE_DEFINITIONS': {'GRID': 'G1', 'SOLVER': 'Solver1a'}}, 'G2_0001': {'COMPILE_DEFINITIONS': {'GRID': 'G2', 'SOLVER': 'Solver1a'}}, 'G2_0000': {'COMPILE_DEFINITIONS': {'GRID': 'G2', 'SOLVER': 'Solver1b'}}, 'G3': {'COMPILE_DEFINITIONS': {'GRID': 'G3', 'SOLVER': 'Solver2'}}, '__CONFIGS': ['G3', 'G2_0000', 'G1_0000', 'G1_0001', 'G2_0001'], '__COMPILE_DEFINITIONS': ['GRID', 'SOLVER']}")