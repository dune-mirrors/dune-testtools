...
#       :multi:
#
#       The source files for the executables to generate. Either this parameter
#       or the TARGET parameter are required.
#
#    .. cmake_param:: TARGET
#       :single:
#
#       The existing target that should be use to generate tests. Either this parameter
#       or the SOURCE parameter are required.
#
#    .. cmake_param:: BASENAME
#       :single:
#
...
function(add_static_variants)
  ...
  # Enforce existence of required arguments
  if(NOT STATVAR_INIFILE)
    message(FATAL_ERROR "The INIFILE parameter is required for function add_static_variants")
  endif()
  if(NOT STATVAR_BASENAME)
    message(FATAL_ERROR "The BASENAME parameter is required for function add_static_variants")
  endif()
  if(NOT STATVAR_SOURCE)
    message(FATAL_ERROR "The SOURCE parameter is required for function add_static_variants")
  endif()
...
function(add_system_test_per_target)
  ...
  # Enforce existence of required arguments
  if(NOT TARGVAR_INIFILE)
    message(FATAL_ERROR "The INIFILE parameter is required for function add_system_test_per_target")
  endif()
  if(NOT TARGVAR_TARGET)
    message(FATAL_ERROR "The TARGET parameter is required for function add_system_test_per_target")
  endif()
...
function(dune_add_system_test)
  ...
  # Enforce existence of required arguments
  if(NOT SYSTEMTEST_INIFILE)
    message(FATAL_ERROR "The INIFILE parameter is required for function dune_add_system_test")
  endif()
  ...
  if(SYSTEMTEST_SOURCE AND SYSTEMTEST_TARGET)
    message(FATAL_ERROR "dune_add_system_test: Use either the SOURCE or the TARGET signature!")
  endif()
  if(NOT SYSTEMTEST_SOURCE AND NOT SYSTEMTEST_TARGET)
    message(FATAL_ERROR "dune_add_system_test: Specify either the SOURCE or the TARGET argument!")
  endif()

  if(SYSTEMTEST_SOURCE)
    # If building from source, the BASENAME parameter is required
    if(NOT SYSTEMTEST_BASENAME)
      message(FATAL_ERROR "The BASENAME parameter is required for function dune_add_system_test")
    endif()
